class Persona {
  ...
  constructor(nombre, apellido) {
    ...
    this.idPersona=++Persona.contadorPersona;
        ...
        console.log("Se han superado la creacion de objetos")
       }
  }
  get nombre() {
    return this.nombre;
...
let persona3 = new Persona("Julia","Antonieta");

let persona4 = new Persona("Monse", "Canseco");

let persona5 = new Persona("Jesus", "Gonzalez");
